...
// Modules
module virtualNetwork '../infrastructure/modules/VirtualNetwork/main.bicep' = {
...
module storageAcount '../infrastructure/modules/StorageAccount/main.bicep' = {
...
module virtualMachine '../infrastructure/modules/VirtualMachine/main.bicep' = {
...
module postgresDB '../infrastructure/modules/Database/main.bicep' = {
